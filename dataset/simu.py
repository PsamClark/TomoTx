...
def tomo_sim_rnd(args):
    (h, w), nproj = args
    image = skimage.draw.random_shapes(image_shape=(h, w), max_shapes=30, min_shapes=10, min_size=w//5, max_size=w//2, intensity_range=(80, 200), allow_overlap=False)[0]
...
if __name__ == '__main__':
    ...
    simu_res = []
    for _ in n_ds:
        simu_res.append(tomo_sim_rnd((img_size, img_size), nproj))
